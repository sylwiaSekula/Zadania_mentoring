...
print('Średnia z próbki 5:', np.mean(poisson))
print('Średnia z próbki 1000:', np.mean(poisson2))
...
print('Wariancja z próbki 5:', np.var(poisson))
print('Wariancja z próbki 1000:', np.var(poisson2))
...
print('Odchylenie standardowe z próbki 5:', np.std(poisson))
print('Odchylenie standardowez próbki 1000:', np.std(poisson2))
...
print('Odchylenie standardowe teoretyczne:', theoretical_standard_deviation)
print('Odchylenie standardowe z próbki 5:', np.std(poisson))
print('Odchylenie standardowe z próbki 1000:', np.std(poisson2))
print('Średnia z estymatorów', np.mean(standard_deviation_list))
print('Efektwyność estymatora:', np.std(standard_deviation_list)/np.mean(standard_deviation_list)*100)
print('')
print('Skośność teoretyczna:', theoretical_skewness)
print('Skośność  z próbki 5:', stats.skew(poisson))
print('Skośność  próbki 1000:', stats.skew(poisson2))
...
print('Kurtoza  z próbki 5:', stats.kurtosis(poisson))
print('Kurtoza  próbki 1000:', stats.kurtosis(poisson2))
